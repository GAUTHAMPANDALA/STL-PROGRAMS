...
// Syntax: std::set<class_name, std::sort_order<class_name> (greater,less)> object_name;
...
int main()
{
	std::set<person> seta={{45,"ramesh"},{65,"vinay"},{85,"ajay"},{35,"kamal"}};
	std::set<person, std::greater<person>> setb={{45,"ramesh"},{65,"vinay"},{85,"ajay"},{35,"kamal"}};
